...
<div style="height:150px; overflow:auto; border:1px solid #dfdfdf;">
    ...
    <label for="<?php echo $widget->get_field_id('logout'); ?>"><?php _e('Show only for Logged-out users') ?></label></p>
    ...
    <label for="<?php echo $widget->get_field_id('login'); ?>"><?php _e('Show only for Logged-in users') ?></label></p>
    
    <p><b>Pages <a href="javascript:dw_toggle_pages()">+/-</a></b></p>
    ...
    <p><b>Categories <a href="javascript:dw_toggle_cats()">+/-</a></b></p>
    ...
    <?php } ?>
    <p><label for="<?php echo $widget->get_field_id('other_ids'); ?>"><?php _e('Comma Separated list of IDs of posts not listed above') ?>:</label>
